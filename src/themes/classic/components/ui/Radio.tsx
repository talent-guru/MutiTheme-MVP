...
export const UiRadioBox: React.FC<React.ComponentPropsWithoutRef<"span">> = ({
  ...
  <span
    {...props}
    className={twMerge(
      "border border-grayscale-200 w-4 h-4 block transition-colors rounded-full group-hover:border-grayscale-600 group-data-[selected]:border-primary group-data-[selected]:border-6 group-hover:group-data-[selected]:border-grayscale-600",
      className
    )}
  />
)
