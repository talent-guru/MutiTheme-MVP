...
export const UiCheckboxBox: React.FC<React.ComponentPropsWithoutRef<"div">> = ({
  ...
  <div
    {...props}
    className={twMerge(
      "border border-grayscale-200 w-4 h-4 flex items-center group-hover:border-grayscale-600 justify-center group-data-[selected=true]:bg-primary group-data-[selected=true]:border-primary group-hover:group-data-[selected=true]:border-grayscale-600 group-hover:group-data-[selected=true]:bg-grayscale-600 transition-colors",
      className
    )}
  />
)
